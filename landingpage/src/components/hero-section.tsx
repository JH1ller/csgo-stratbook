        ...
        <div className="container px-4 md:px-6">
          <div className="flex flex-col justify-center space-y-4 items-center gap-2">
            <h1 className="text-4xl font-bold tracking-tighter sm:text-5xl xl:text-6xl/none text-center">
              ...
              <span className="font-bold tracking-tighter bg-gradient-to-r from-emerald-300 via-emerald-500 to-emerald-600 bg-clip-text text-transparent">
                CS2 Strats.
              </span>
            </h1>
            <p className="max-w-[600px] text-muted-foreground md:text-xl text-center">
              Collaborate with your team, manage strategies, and perfect your game plan with our real-time tactics
              board.
              <br />
              Join over 3500 teams who already use Stratbook.
            </p>
