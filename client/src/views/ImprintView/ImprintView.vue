    ...
    <div class="imprint-view__content">
      ...
      <div class="impressum">
        ...
        <p>
          ...
          wir derartige Links umgehend entfernen.<br /><br /><strong>Datenschutz</strong><br /><br />
...
<script lang="ts" src="./ImprintView.ts"></script>
<style lang="scss" src="./ImprintView.scss"></style>
